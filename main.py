...
with sqlite3.connect('Book.db') as db:
    ...
    """
    # dict = {1:('Александр Сергеевич Пушкин', 1799, 1837, 'Москва'),2:('Фёдор Иванович Тютчев', 1803, 1873, 'Овстуг'),
    # 3:('Фёдор Михайлович Достоевский', 1821, 1881, 'Москва'), 4:('Михаил Булгаков', 1891, 1940, 'Киев'),
    # 5:('Иван Алексеевич Бунин', 1870, 1953, 'Воронеж'), 6:('Иван Сергеевич Тургенев', 1818, 1883, 'Орел')}
